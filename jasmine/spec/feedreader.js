...
$(function() {
    ...
    */
	...
	describe('Initial Entries', function() {
         ...
         */
		it('calls loadFeed and there is at least 1 entry in the feed container', function(done) {
			var onLoadFeedSpy = spyOn(window, "loadFeed").and.callThrough();
        	...
        	expect(onLoadFeedSpy).toHaveBeenCalled();
        });
	});
